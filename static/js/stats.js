...
function render(data) {
  ...
  document.getElementById('content').innerHTML = `
    ...
    <div class="section">
      ...
      <div class="fun-grid">
        <div class="fun-card"><div class="fun-icon"><img src="static/figures/vache.ico"></div><div><div class="fun-num">${fmt(fun.vaches)}</div><div class="fun-lbl">vaches bout à bout (Ô la vache !)</div><div class="fun-desc">Une vache ≈ 2.4 m</div></div></div>
